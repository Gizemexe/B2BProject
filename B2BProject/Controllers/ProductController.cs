...
namespace EcommerceProject2.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Products(Product product, HttpPostedFileBase img)
        {
            using (var entities = new B2BDbEntities())
            {
                ...
                product.Category = entities.Categories.FirstOrDefault(i => i.Category_id == product.Category_id);
        ...
        [HttpPost]
        public ActionResult UpdateProducts(Product product, HttpPostedFileBase img)
        {
            using (var entities = new B2BDbEntities())
            {
                ...
                if (existingProduct != null)
                {
                    ...
                    existingProduct.PackagePrice = product.PackagePrice;
                    existingProduct.Category_id = product.Category_id;
                    existingProduct.Stock = product.Stock;

                    if (Session["Admin_id"] != null)
                    {
                        existingProduct.User_id = Convert.ToInt32(Session["Admin_id"]);
                    }
